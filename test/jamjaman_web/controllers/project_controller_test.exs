defmodule JamjamanWeb.ProjectControllerTest do
  use JamjamanWeb.ConnCase

  alias Jamjaman.Content

  @create_attrs %{approval_time: ~N[2010-04-17 14:00:00.000000], description: "some description", is_approved: true, is_ofr: true, status: "some status", title: "some title"}
