defmodule JamjamanWeb.CategoryControllerTest do
  use JamjamanWeb.ConnCase

  alias Jamjaman.Masterdata

  @create_attrs %{description: "some description", logo: "some logo", title: "some title"}
  ...
  describe "index" do
    test "lists all category", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Listing Category"
    end
  end
