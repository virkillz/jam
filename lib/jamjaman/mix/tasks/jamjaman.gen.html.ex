defmodule Mix.Tasks.Jamjaman.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix jamjaman.gen.html Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix jamjaman.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix jamjaman.gen.html Sales User users --web Sales
  ...
  a `--table` option may be provided. For example:
      ...
      mix jamjaman.gen.html Accounts User users --table cms_users
  ...
  Read the documentation for `jamjaman.gen.schema` for more information on
  attributes.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella? do
      Mix.raise "mix jamjaman.gen.html can only be run inside an application directory"
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/jamjaman.gen.html", binding, files)
