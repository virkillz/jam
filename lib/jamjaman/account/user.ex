defmodule Jamjaman.Account.User do
  use Ecto.Schema
  ...
  def put_default_avatar(changeset) do
    change(changeset, avatar: get_random_avatar)
  end

  def get_random_avatar() do
    stock = ["Worker", "Photo", "Pilot", "Priest", "Repairer", "Soldier", "Student", "Support", "Waiter", "Woman", "Boss", "Boy", "Captain", "Chef", "Cowboy", "Doctor", "Engineer", "Fireman", "Flightattendant", "Judge", "Maid", "Man", "Nurse", "Ph_D", "Police"]
    "/img/avatardefault/" <> Enum.random(stock) <> ".png"
  end
