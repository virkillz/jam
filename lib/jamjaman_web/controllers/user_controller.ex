defmodule JamjamanWeb.UserController do
  use JamjamanWeb, :controller

  alias Jamjaman.Logging
  alias Jamjaman.Account
  alias Jamjaman.Account.User
  alias Jamjaman.Auth.Guardian
  ...
  def login(conn, _params) do
      changeset = Account.change_user(%User{})
      render conn, "login.html", layout: {JamjamanWeb.LayoutView, "center.html"}, changeset: changeset
  end
  ...
  case Account.authenticate_user(user, password) do
    {:ok, user} ->
      ...
      |> render("login.html", layout: {JamjamanWeb.LayoutView, "center.html"}, changeset: changeset)        
        else
  ...
  def locked(conn, _) do
    ...
    conn
    |> Guardian.logout
    |> render("locked.html", layout: {JamjamanWeb.LayoutView, "center.html"}, name: name, avatar: avatar, username: username, changeset: changeset)
  end
